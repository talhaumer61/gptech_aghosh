...
//-----------------------------------------------
	...
	require_once("include/campus/visit/purpose/query.php");
...
<div class="col-md-12">';
//-----------------------------------------------
	include_once("include/campus/visit/purpose/list.php");
	include_once("include/modals/visit/purpose/add.php");
//-----------------------------------------------
echo '
</div>
</div>';
