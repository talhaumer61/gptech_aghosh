...
if(isset($_POST['to_donor'])){ $donor = '1';}else{ $donor = '2';}
//------------------------------------------------
...
//--------------------------------------.
	...
	$remarks = 'Add Notification ID#"'.cleanvars($latestID).'"';
...
//--------------------------------------
	if($sqllms) { 
//--------------------------------------
	$remarks = 'Update Notification ID#"'.cleanvars($_POST['not_id']).'" details';
		$sqllmslog  = $dblms->querylms("INSERT INTO ".LOGS." (
															id_user										, 
															filename									, 
															action										,
