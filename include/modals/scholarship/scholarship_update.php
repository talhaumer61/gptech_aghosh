...
//---------------------------------------------------------
	$sqllms	= $dblms->querylms("SELECT  id, status, percent, id_cat, id_class, id_std, id_session, note
								   FROM ".SCHOLARSHIP."
	...
	<input type="hidden" name="id" id="id" value="'.cleanvars($_GET['id']).'">
		...
		echo'
			...
			<div class="form-group mt-sm">
				...
				<div class="col-md-9">
					<input type="number" class="form-control" name="percent" id="percent" value="'.$rowvalues['percent'].'" required title="Must Be Required"/>
				</div>
			</div>
			<div class="form-group mb-md">
