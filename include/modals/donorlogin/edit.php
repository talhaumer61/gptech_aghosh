...
<div class="row">
	<div class="col-md-12">
		<section class="panel panel-featured panel-featured-primary">
			<form action="donorLogin.php" class="form-horizontal" id="form" enctype="multipart/form-data" method="post" accept-charset="utf-8">
			<input type="hidden" name="adm_id" id="adm_id" value="'.cleanvars($_GET['id']).'">
				...
				<div class="panel-body">
					...
					<div class="form-group mt-sm">
						...
						<div class="col-md-9">
							<input type="text" class="form-control" id="adm_email" name="adm_email" value="'.$rowsvalues['adm_email'].'" readonly/>
						</div>
					</div>
					<div class="form-group mt-sm">
				...
				<footer class="panel-footer">
					<div class="row">
						<div class="col-md-12 text-right">
							<button type="submit" class="btn btn-primary" id="updateDonor" name="updateDonor">Update</button>
