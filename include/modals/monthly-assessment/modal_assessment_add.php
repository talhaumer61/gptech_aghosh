	...
	<section class="panel panel-featured panel-featured-primary">
		<form action="monthly_assessment.php" class="form-horizontal" id="form" enctype="multipart/form-data" method="post" accept-charset="utf-8">
			...
			<div class="form-group">
				...
				<div class="col-md-9">
					<input type="file" class="form-control" name="ass_file" id="ass_file" required title="Must Be Required"/>
				</div>
			</div>
			<div class="form-group mb-md">
				<label class="col-md-3 control-label">Note</label>
				<div class="col-md-9">
					<textarea class="form-control" rows="2" name="ass_note" id="ass_note"></textarea>
				</div>
			</div>
			<div class="form-group">
