											...
											<div class="col-md-4">
												<div class="form-group mt-sm">
													<div class="col-md-12">
														...
														<input type="number" id="amount" name="amount[]" class="form-control cats" required title="Must Be Required" value="'.$valuefeeprt['amount'].'"'; /*if($rowsvalues['status'] == 1 || $rowdoc['cat_id'] == '1') {echo'readonly';}*/ echo' />
													</div>
												</div>
											</div>
											';
