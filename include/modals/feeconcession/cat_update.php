...
//---------------------------------------------------------
	$sqllms	= $dblms->querylms("SELECT  cat_id, cat_status, cat_name, cat_amount, cat_detail, id_campus
...
<section class="panel panel-featured panel-featured-primary">
	<form action="feeconcession_cat.php" class="form-horizontal" id="form" enctype="multipart/form-data" method="post" accept-charset="utf-8" autocomplete="off">
	<input type="hidden" name="cat_id" id="cat_id" value="'.cleanvars($_GET['id']).'">
		...
		<div class="panel-body">
			...
			<div class="form-group mt-sm">
				...
				<div class="col-md-9">
					<input type="number" class="form-control" name="cat_amount" id="cat_amount" value="'.$rowsvalues['cat_amount'].'" required title="Must Be Required"/>
				</div>
			</div>
