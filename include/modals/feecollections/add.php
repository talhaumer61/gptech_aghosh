			...
			<div class="panel-body">			
				<div class="form-group mt-sm">
					<div class="col-md-12">
						...
						<input type="text" class="form-control" name="challanno" id="challanno" value="9930'.date("y").'" maxlength="11" required title="Must Be Required" oninput="if(this.value.length === 11) get_cashchallandetail(this.value)" tabindex="1" />
					</div>
				</div>
			...
			<footer class="panel-footer">
				<div class="row">
					<div class="col-md-12 text-right">
						<button type="submit" class="btn btn-primary" id="challan_cashpay" style="display:none;" name="challan_cashpay"  onClick=\'return confirmSubmit()\'>Paid</button>
