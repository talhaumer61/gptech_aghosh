...
//---------------------------------------------------------
    ...
    //------------- Accounts Details ---------------------
    $sqllmsAcc	= $dblms->querylms("SELECT f.id, f.status, f.id_month, f.challan_no, f.issue_date, f.paid_date, f.due_date, f.total_amount, f.paid_amount, f.remaining_amount,  c.class_name, cs.section_name, s.session_name
                                    FROM ".FEES." f		
