<?php 
if($_SESSION['userlogininfo']['LOGINIDA'] == 1){ 
echo '
<!-- Add Modal Box -->
		...
		<form action="campuslogin.php" class="form-horizontal" id="form" enctype="multipart/form-data" method="post" accept-charset="utf-8">
			...
			<div class="panel-body">
				<div class="form-group mb-md">
					...
					<div class="col-md-9">
						<select class="form-control" required title="Must Be Required" data-plugin-selectTwo data-width="100%" data-minimum-results-for-search="Infinity" id="id_campus" name="id_campus" onchange="get_campusdetail(this.value)">
