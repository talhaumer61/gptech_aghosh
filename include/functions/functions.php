...
function get_paymethod($id) {
	$listpaymethod= array (
							...
							'3' => '<span class="label label-warning">UBL</span>'	,
							...
							'7' => '<span class="label label-info">RAAST QR</span>'
						);
...
$FEE_CHALLAN_RIGHTS = array('4', '324', '325', '326', '327');
...
function sendWhatsApp($number, $message)
{
    ...
    $url = WA_URL . '?' . http_build_query($params);
