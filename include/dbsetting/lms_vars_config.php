...
//	$dblms->lastestid();
	...
	define('LMS_NAME'				, 'gptech_ags_update');
	define('LMS_USERNAME'			, 'root');
	define('LMS_USERPASS'			, '');
	*/
	define('LMS_HOSTNAME'			, 'localhost');
	define('LMS_NAME'				, 'swohgequ_aghosh2025');
	define('LMS_USERNAME'			, 'swohgequ_ags2025');
	define('LMS_USERPASS'			, '1XYB3(S5fq?M');
...
///-----------------DB Tables ------------------------ 
	...
	define('RAAST_QR_DETAILS'		, 'sms_raast_qr_details');
...
//--------------------------------------------------
//	define('WA_URL'				, "https://waapi.paklimited.com/api/create-message");
//	define('WA_APPKEY'			, "3e969b3e-629b-4d58-a550-e83c20293290");
//	define('WA_AUTHKEY'			, "XX7qqFibTT17CT6hDxKAK78DouIEwdOnomWtpf73DJsJlleDr5");
	...
	define("LATEFEE"			, 300);
	define("BASE_URL"			, "https://aghosh.gptech.pk");
	...
	define("ACADEMIC_SSTART"	, date("Y").'-02');
	define("ACADEMIC_ESTART"	, (date("Y") + 1).'-03');
	...
	define("UBL_AGS_CODE"		, "MCA-325 731 744");
	define("UBL_TEH_CODE"		, "MCA-325 732 068");

	define('BANKCO_USERNAME'		, "aghoshcomplex.com");
	define('BANKCO_PASSWORD'		, "AC@4933&!");
	define('BANKCO_CLIENTID'		, "6");
	define('BANKCO_CLIENTSECRET'	, "82628ddd8ec2613dc07e92faa31a0d84");
	define('BANKCO_ACCESSTOKENURL'	, "http://bankco.pk/api/get-access-token.php");
	define('BANKCO_QRCODEURL'		, "http://bankco.pk/api/get-qr-code.php");