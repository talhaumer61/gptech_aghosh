...
//--------------------------------------------------
	define('WA_APPKEY'			, "4e579148-9633-47b6-a7ce-2552823ea7a8");
	define('WA_AUTHKEY'			, "rm1q4T5c5ZTpFdWvdZLBe2Jq3jB66OQETQJzZop3GX3NXs8fA4");
	define('LMS_IP'				, $ip);
	define('LMS_DO'				, $do);
	define('LMS_EPOCH'			, date("U"));
	define('LMS_VIEW'			, $view);
	define("LATEFEE"			, 300);
	define("BASE_URL"			, "http://localhost/GPT/aghosh.gptech.pk");
	define('TITLE_HEADER'		, 'School Management System');
	define("SITE_NAME"			, "School Management System");
	define("SITE_URL"			, "http://localhost/GPT/aghosh.gptech.pk/");
