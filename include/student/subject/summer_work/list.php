...
//-----------------------------------------------------
    ...
    echo '
                <tr>
                    ...
                    <td class="center"><a href="uploads/summer-work/'.$value_summerwork['id_month'].'" download="Vacation Work - '.$value_summerwork['subject_code'].'-'.$value_summerwork['subject_name'].'" class="btn btn-success btn-xs");"><i class="glyphicon glyphicon-download"></i></a></td>
                </tr>';
    }
    //-----------------------------------------------------
    echo '
