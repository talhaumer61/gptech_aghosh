...
<section role="main" class="content-body">
    <section class="panel panel-featured panel-featured-primary appear-animation mt-sm" data-appear-animation="fadeInRight" data-appear-animation-delay="100">';
        ...
        // Exam Date Sheet
        $sqllmsExam	= $dblms->querylms("SELECT tp.type_name, e.emply_name, d.dated, d.start_time, d.end_time, s.subject_name, s.subject_code, r.room_no
                                        FROM ".DATESHEET." 	            t
                                        ...
                                        WHERE t.status = '1' AND t.id_class = '".$values_std['id_class']."' AND t.is_deleted != '1'
