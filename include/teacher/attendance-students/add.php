...
// //-----------------------------------------------
$today = date("m/d/Y");
if(isset($_POST['dated'])){$date = $_POST['dated'];} else{$date = $today;}
echo'
			...
			<div class="row mb-lg">
				...
				<div class="col-sm-4 col-sm-offset-4">
					<div class="form-group">
						...
						<input type="text" class="form-control" name="dated" id="dated" required title="Must Be Required" data-plugin-datepicker name="dated" value="'.$date.'" >
					</div>
				</div>
				<!-- <div class="col-md-4">
