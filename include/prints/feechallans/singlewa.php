	...
	// QRcode::png($link, $filename, $errorCorrectionLevel, $matrixPointSize, 2);
		...
		for($ifee = 1; $ifee<=3; $ifee++){
			...
			if($feercord['id_type']=='2'){
				echo '
				<td width="32%" '.$rightborder.' class="'.$clspaid.'">
					<table style="border-collapse:collapse; margin-top: 5px; margin-bottom: 5px;" width="100%" border="0">
						<tr>
							...
							<td>
								<h6 style="writing-mode: vertical-lr; text-orientation: mixed; border: 1px dashed black; border-radius: 12px; padding: 5px 3px;"> <span class="spanh1">'.$copyfor.'</span></h6>
							</td>
						</tr>
					</table>
