<?php 
//-----------------------------------------------------
$sqllms	= $dblms->querylms("SELECT s.std_id, s.std_status, s.std_name, s.std_fathername, s.id_guardian,
								s.std_nic, s.std_phone, s.std_whatsapp, s.std_email, s.is_orphan, s.id_class, s.id_section, s.id_group, s.id_session,  s.std_rollno,
								...
								c.class_name, se.section_name, gr.group_name 
								FROM ".STUDENTS." s
								...
								AND s.std_id = '".cleanvars($_GET['std'])."' LIMIT 1");
			...
			<div class="widget-toggle-expand mb-xs">
				<div class="widget-content-expanded">
					<table class="table table-striped table-condensed mb-none">
						...
						<tr>
							<td>Group</td>
							<td align="right">'.$rowsvalues['group_name'].'</td>
						</tr>
						<tr>
							<td>Class</td>
						...
						<tr>
							<td>Email</td>
							<td align="right">'.$rowsvalues['std_email'].'</td>
						</tr>
						<tr>
							<td>Gender</td>
						...
						<tr>
							<td>Orphan</td>
							<td align="right">'.get_statusyesno($rowsvalues['is_orphan']).'</td>
						</tr>
						<tr>
							<td>Blood Group</td>
						...
						<tr>
							<td>Date Of Birth</td>
							<td align="right">'; if($rowsvalues['std_dob'] != '0000-00-00'){echo $rowsvalues['std_dob'];} echo'</td>
						</tr>
						<tr>
							<td>NIC</td>
