...
<tbody>';
//-----------------------------------------------------
$sqllms	= $dblms->querylms("SELECT c.cat_id, c.cat_status, c.cat_name, c.cat_duration, c.cat_type
								   FROM ".FEE_CATEGORY." c  
...
<tr>
	...
	<td>'.$rowsvalues['cat_duration'].'</td>
	<td>'.$rowsvalues['cat_type'].'</td>
	<td style="text-align:center;">'.get_status($rowsvalues['cat_status']).'</td>';
if(($_SESSION['userlogininfo']['LOGINTYPE'] == 1) || ($_SESSION['userlogininfo']['LOGINTYPE']  == 2) || Stdlib_Array::multiSearch($_SESSION['userroles'], array('right_name' => '32', 'updated' => '1'))){ 
	echo '
	<td style="text-align:center;">';
	if(($_SESSION['userlogininfo']['LOGINTYPE']  == 1) || ($_SESSION['userlogininfo']['LOGINTYPE'] == 2) || Stdlib_Array::multiSearch($_SESSION['userroles'], array('right_name' => '32', 'updated' => '1'))){
		if($rowsvalues['cat_id']!=13){
			if($rowsvalues['cat_id']!=14){
