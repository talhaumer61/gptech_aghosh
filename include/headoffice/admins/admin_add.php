...
<div class="row mt-sm">
	<div class="col-sm-6">
		<div class="form-group">
			...
			<input type="email" class="form-control" name="adm_email" id="adm_email" required title="Must Be Required" value="">
		</div>
	</div>
	<div class="col-sm-6">
		<div class="form-group">
...
<div class="row mt-sm">
	<div class="col-sm-6">
		<div class="form-group">
			...
			<select name="adm_type" data-plugin-selectTwo data-width="100%" class="form-control populate" required title="Must Be Required" >
