...
<div class="row">
	<div class="col-md-12">
		<section class="panel panel-featured panel-featured-primary">
			<form action="exam_registration_campus.php?view=add" class="mb-lg validate" enctype="multipart/form-data" method="post" accept-charset="utf-8" autocomplete="off">
									...
									while($value_classes = mysqli_fetch_array($sqllmsclasses)):
										$sqllmsstd	= $dblms->querylms("
																			...
																			WHERE 
																					s.is_deleted 		= '0'
																				AND 
																					s.id_class      	= ".cleanvars($value_classes['class_id'])."
																				AND
																					s.id_campus        	= ".cleanvars($_SESSION['userlogininfo']['LOGINCAMPUS'])."
																		");
										if (mysqli_num_rows($sqllmsstd)):
echo'
											<option value="'.$value_classes['class_id'].'">'.$value_classes['class_name'].'</option>
';
										endif;
									endwhile;
									echo'
