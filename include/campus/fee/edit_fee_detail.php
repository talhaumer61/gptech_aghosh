		...
		<form action="feesetup.php" class="form-horizontal" id="form" enctype="multipart/form-data" method="post" accept-charset="utf-8" >
			...
			<div class="panel-body">
				...
				<div class="form-group mt-sm">
					...
					<div class="col-md-9">
						<input type="text" class="form-control" name="dated" id="dated" value="'.date('m/d/Y',strtotime($value_setup['dated'])).'"autocomplete="off" data-plugin-datepicker required title="Must Be Required"/>
					</div>
				</div>
				<div class="form-group">
						...
						while($rowsvalues = mysqli_fetch_array($sqllms)) {
							...
							<tr>
								...
								<td>
									<div class="form-group mt-sm">
										<div class="col-md-12">
											<input type="number" class="form-control" name="amount['.$srno.']" id="amount['.$srno.']" value="'.$value_detail['amount'].'""/>
										</div>
									</div>
								</td>
								<td>
