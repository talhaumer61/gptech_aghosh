...
<header class="panel-heading">';
	if(($_SESSION['userlogininfo']['LOGINFOR'] == 1) || ($_SESSION['userlogininfo']['LOGINIDA'] == 4) || Stdlib_Array::multiSearch($_SESSION['userroles'], array('right_name' => '47', 'add' => '1'))){
	echo'
...
<thead>
	<tr>
		...
		if(($_SESSION['userlogininfo']['LOGINFOR'] == 1) || ($_SESSION['userlogininfo']['LOGINIDA'] == 4)){
...
<tbody>';
//-----------------------------------------------------
$sqllms	= $dblms->querylms("SELECT c.class_id, c.class_name, c.class_code, c.id_classgroup, c.class_status  
								   FROM ".CLASSES." c  
								   WHERE c.class_id != '' AND c.is_deleted = '0'
...
<tr>
	...
	<td>'.get_classgroup($rowsvalues['id_classgroup']).'</td>
