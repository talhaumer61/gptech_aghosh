...
<section class="panel panel-featured panel-featured-primary">
	<header class="panel-heading">
		<div style="display:flex; align-items:center; justify-content:space-between;">
			...
			<form action="#" method="GET" autocomplete="off" style="display:flex; justify-content:space-between; margin-left:20px;">
	...
	<div class="panel-body" style="display:flex; flex-direction:column;">
			<span class="pull-right" style="margin-bottom:10px; display:flex; gap:10px; justify-content:flex-end;">';
				if(($_SESSION['userlogininfo']['LOGINIDA']  == 4 || $_SESSION['userlogininfo']['LOGINIDA']  == 2095)){ 
