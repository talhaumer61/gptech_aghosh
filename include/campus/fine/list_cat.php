...
$sqllms	= $dblms->querylms("SELECT cat_id, cat_status, cat_name, cat_detail
								   ...
								   WHERE id_campus = '".cleanvars($_SESSION['userlogininfo']['LOGINCAMPUS'])."' AND cat_type = '3'
								   ORDER BY cat_id ASC");
$srno = 0;
//-----------------------------------------------------
...
<tr>
	...
	if(($_SESSION['userlogininfo']['LOGINTYPE']  == 1) || ($_SESSION['userlogininfo']['LOGINTYPE']  == 2) ||  Stdlib_Array::multiSearch($_SESSION['userroles'], array('right_name' => '76', 'edit' => '1'))){ 
	echo'
	...
	if(($_SESSION['userlogininfo']['LOGINTYPE']  == 1) || ($_SESSION['userlogininfo']['LOGINTYPE']  == 2) || Stdlib_Array::multiSearch($_SESSION['userroles'], array('right_name' => '76', 'delete' => '1'))){ 
	echo'
