...
<tbody>';
//-----------------------------------------------------
$sqllms = $dblms->querylms("SELECT a.adm_id, a.adm_status, a.adm_username, a.adm_fullname, a.adm_email, a.adm_phone, a.adm_photo, GROUP_CONCAT(CONCAT(s.std_name) ORDER BY s.std_name SEPARATOR ', ') AS student_names
							FROM ".ADMINS." a
							INNER JOIN ".STUDENTS." s ON s.id_loginid = a.adm_id AND s.is_deleted != '1'
							WHERE 
								a.adm_logintype = '4'
								AND a.is_deleted != '1'
...
<tr>
	...
	<td>'.$rowsvalues['student_names'].'</td>
