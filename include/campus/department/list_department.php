...
if(($_SESSION['userlogininfo']['LOGINTYPE'] == 1) || ($_SESSION['userlogininfo']['LOGINTYPE']  == 2) || Stdlib_Array::multiSearch($_SESSION['userroles'], array('right_name' => '10', 'add=' => '1'))) { 
echo'
...
<tr>
	...
	<td>';
	if(($_SESSION['userlogininfo']['LOGINTYPE'] == 1) || ($_SESSION['userlogininfo']['LOGINTYPE']  == 2) || Stdlib_Array::multiSearch($_SESSION['userroles'], array('right_name' => '10', 'edit=' => '1'))) { 
	...
	if(($_SESSION['userlogininfo']['LOGINTYPE'] == 1) || ($_SESSION['userlogininfo']['LOGINTYPE']  == 2) || Stdlib_Array::multiSearch($_SESSION['userroles'], array('right_name' => '10', 'delete=' => '1'))) { 
		echo'<a href="#" class="btn btn-danger btn-xs" onclick="confirm_modal(\'department.php?deleteid='.$rowsvalues['dept_id'].'\');"><i class="el el-trash"></i></a>';
	}
	echo '
	</td>
</tr>';
