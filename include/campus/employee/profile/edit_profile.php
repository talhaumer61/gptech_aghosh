 ...
 <input type="hidden" name="emply_id" id="emply_id" value="'.cleanvars($_GET['id']).'">
	<fieldset class="mt-lg">
		...
		<div class="form-group">
			...
			<div class="col-md-8">
				<select class="form-control" required title="Must Be Required" data-plugin-selectTwo data-width="100%" name="id_designation">
					<option value="">Select</option>';
		...
		<div class="form-group">
			...
			<div class="col-md-8">
				<select class="form-control" data-plugin-selectTwo data-width="100%" name="id_class" onchange="get_editclasssection(this.value)">
					<option value="">Select</option>';
		...
		<div class="form-group">
			...
			<div class="col-md-8">
				<select data-plugin-selectTwo data-width="100%" name="emply_gender" class="form-control populate">
		...
		<div class="form-group">
			...
			<div class="col-md-8">
				<select name="emply_bloodgroup" value="'.$rowsvalues['emply_bloodgroup'].'" class="form-control populate" data-plugin-selectTwo data-width="100%" >
...
if(($_SESSION['userlogininfo']['LOGINTYPE'] == 1) || ($_SESSION['userlogininfo']['LOGINTYPE']  == 2)|| Stdlib_Array::multiSearch($_SESSION['userroles'], array('right_name' => '16', 'edit' => '1'))){ 
	echo '
