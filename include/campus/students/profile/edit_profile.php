...
$sqllms	= $dblms->querylms("SELECT s.std_id, s.std_status, s.std_name, s.std_fathername, s.std_gender, s.id_guardian,
								...
								s.std_fathercnic, s.id_donor, s.donation_amount, s.donation_duration,
 ...
 <input type="hidden" name="std_id" id="std_id" value="'.cleanvars($_GET['id']).'">
	<fieldset class="mt-lg">
		...
		<!-- div class="form-group">
			...
			<div class="col-md-8">
				<input type="text" class="form-control" name="std_phone" id="std_phone" value="'.$rowsvalues['std_phone'].'"/>
			</div>
		</div -->
		<div class="form-group">
			<label class="col-sm-3 control-label">Whatsapp <span class="required">*</span></label>
			<div class="col-md-8">
				<input type="text" class="form-control" name="std_whatsapp" id="std_whatsapp" value="'.$rowsvalues['std_whatsapp'].'" required/>
			</div>
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			...
			<div class="col-md-8">
				<input type="text" class="form-control" required name="std_nic" id="std_nic" value="'.$rowsvalues['std_nic'].'"/>
			</div>
		</div>
		<div class="form-group">
...
//-----------------------------------------------
if(($_SESSION['userlogininfo']['LOGINTYPE'] == 1) || ($_SESSION['userlogininfo']['LOGINTYPE']  == 2) || Stdlib_Array::multiSearch($_SESSION['userroles'], array('right_name' => '1', 'edit' => '1'))){
	echo '
...
<script>
	jQuery(function($) {
      $.mask.definitions["~"]="[+-]";
      $("#std_fathercnic").mask("99999-9999999-9");
      $("#std_nic").mask("99999-9999999-9");
	  $("#std_whatsapp").mask("9999-9999999");
	  $("#std_phone").mask("9999-9999999");
