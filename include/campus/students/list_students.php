...
<section class="panel panel-featured panel-featured-primary">
	...
	<div class="panel-body">
		...
		//------------- Pagination ---------------------
		$sql = "SELECT s.std_id, s.std_status, s.std_name, s.std_fathername, s.std_gender, s.is_orphan, s.is_orphan_approved, s.std_fathercnic, s.std_whatsapp, s.id_class, s.id_session, s.std_rollno, s.std_regno, s.std_photo, s.is_hostelized, c.class_name
				FROM ".STUDENTS." 		s
				...
				<table class="table table-bordered table-striped table-condensed" style="margin-top: 10px;">
					...
					while($rowsvalues = mysqli_fetch_array($sqllms)) {
						...
						<tr>
							...
							<td>'.$rowsvalues['std_fathercnic'].'</td>';
							echo'
