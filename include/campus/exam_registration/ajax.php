    ...
    if ($subjects) {
        if (mysqli_num_rows($sqllmsStd)) {
            ...
            <div class="panel-heading text-center" style="background-color: #c54147;">
                <h4 class="panel-title" style="color: #fff;"><b>No Students Found In This Class</b>      </h4>
            </div>';        
        }
    } else {
        echo '
        <div class="panel-heading text-center" style="background-color: #c54147;">
            <h4 class="panel-title" style="color: #fff;"><b>No Subjects In That Class</b></h4>
        </div>';
    }
} else {
    echo '
    <div class="panel-heading text-center" style="background-color: #c54147;">
        <h4 class="panel-title" style="color: #fff;"><b>Please Select Any Class</b></h4>
    </div>';
}
?>