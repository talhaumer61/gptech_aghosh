...
<section class="panel panel-featured panel-featured-primary">
	<header class="panel-heading">';
		...
		echo'
		<h2 class="panel-title"><i class="fa fa-list"></i> Challans List (Inactive)</h2>
	</header>
						...
						while($rowsvalues = mysqli_fetch_array($sqllms)) {
							...
							<tr>
								...
								if(isset($valuesqllmscheck['challan_no']) &&  $valuesqllmscheck['challan_no'] == $rowsvalues['challan_no']){
									...
									if(in_array($_SESSION['userlogininfo']['LOGINIDA'], [4, 325, 327])){
									...
									if(in_array($_SESSION['userlogininfo']['LOGINIDA'], [4, 325])){
										echo '<a href="#show_modal" class="modal-with-move-anim-pvs btn btn-primary btn-xs mr-xs" onclick="showAjaxModalZoom(\'include/modals/fee_challans/modal_feechallan_update.php?id='.$rowsvalues['id'].'\');"><i class="glyphicon glyphicon-edit"></i></a>';

										if($_SESSION['userlogininfo']['LOGINIDA'] == 4){
											echo ' <a href="#show_modal" class="modal-with-move-anim-pvs btn btn-info btn-xs mr-xs" onclick="showAjaxModalZoom(\'include/modals/fee_challans/modal_feechallan_payment.php?id='.$rowsvalues['id'].'\');"><i class="glyphicon glyphicon-compressed"></i></a>';
										}
									}
