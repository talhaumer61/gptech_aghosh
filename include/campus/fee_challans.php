...
//-----------------------------------------------
	...
	// }
		...
		include_once("fee_challans/list_feechallans_inactive.php");
		include_once("include/modals/fee_challans/modal_feechallan_add.php");
		include_once("include/modals/fee_challans/status_challan_report.php");
		include_once("include/modals/fee_challans/print_challan.php");
		include_once("include/modals/fee_challans/change_duedate.php");
	}
	else{
