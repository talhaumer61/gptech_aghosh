...
We are thrilled to have you join our community. Congratulations on taking the first step towards your academic journey.

Admission Challan Number: '.$challano.'
Admission Challan Month: '.date('F Y', strtotime($issue_date)).'
Admission Fee Amount: Rs. '.number_format($totalAmount).'
...
Accounts Office
Aghosh Complex.';
            $mobilenum1 = '92'.str_replace('-', '', ltrim($_GET['phone'], '0'));
            ...
            curl_setopt_array($curl, array(
                                            ...
                                            CURLOPT_POSTFIELDS       => array('appkey' => WA_APPKEY,'authkey' => WA_AUTHKEY,'to' => $mobilenum1,'message' => $msgs,'file' => ''),
                                        ));
