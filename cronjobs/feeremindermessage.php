    ...
    foreach ($Adminslist as $listwa) :
        ...
        if($mobilenum1 !='' &&  strlen($mobilenum1) == 12 ) {
           ...
           $msgs =  "\nReminder for Fee Payment\n" .
                    "Dear " . $listwa['std_name'] . "\n" .
                    "Please make sure to submit your school fee payment for the month of " . get_monthtypes($listwa['id_month']) . "-" . date('Y', strtotime($listwa['issue_date'])) . " before " . date('d-m-Y', strtotime($listwa['due_date'])) . " to avoid any inconvenience in case of non-payment of the school fee fine of Rs 500 will be imposed with the monthly fee.\n\n" .
                    "All Mobile Banking Payments\n" .
                    "Challan Amount Rs. " . number_format($grandTotal) . "/-\n" .
                    "1 Bill Invoice ID: NA\n\n" .
                    "https://aghosh.gptech.pk/raast_qr.php?challanNo=" . get_dataHashingOnlyExp($listwa['challan_no'], true) . "\n\n" .
